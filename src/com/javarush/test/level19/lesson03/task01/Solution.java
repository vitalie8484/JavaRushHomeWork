...
public class Solution {
    ...
    public static class TableAdapter implements BTable{
        ...
        private ATable aTableIntern;

        public TableAdapter(ATable aTableIntern) {
            this.aTableIntern = aTableIntern;
        }

        public String getHeaderText() {
            return "[" + aTableIntern.getCurrentUserName() + "] : " + aTableIntern.getTableName();
        }
    }
